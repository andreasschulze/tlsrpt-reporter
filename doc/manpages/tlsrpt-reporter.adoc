...
*--develmode*=_n_::
Control development mode: 0 turns development mode off, 1 activates development mode.
In development mode the reporter behaves very different and might send out reports incomplete reports too early or might not send out reports at all!
{production-warning}  
...
*tlsrpt-reporter --fetchers "tlsrpt-fetcher, ssh user@remote.host tlsrpt-fetcher"*
